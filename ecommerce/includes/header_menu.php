...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">THE SHOPPING ARENA</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#headphones" class="dropdown-item">Cosmetics</a>
                               </div>
                       </li>
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    ?>
                    <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item "><a href="#login" class="nav-link" data-toggle="modal"><i class="fa fa-sign-in"></i>Admin Login</a></li>
            ...
            <div class="modal-body">
              <form action="adminlogin.php" method="post">
                 <div class="form-group">
                     ...
                     <input type="adminid" class="form-control"  name="ladminid" placeholder="Enter adminid" required>
                </div>
                <div class="form-group">
                    <label for="pwd">Password:</label>
                    <input type="apassword" class="form-control" id="pwd"  name="lapassword" placeholder="Password" required>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input">
                    <label for="checkbox" class="form-check-label">Check me out</label>
                </div>
                <button type="submit" class="btn btn-secondary btn-block" name="Submit">Admin Login</button>
              </form>
              <a href="http://">forgot password ?</a>
            </div>
          </div>
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-group">
                     ...
                     <input type="text" class="form-control"  id="validation1" name="adress" placeholder="Enter address" required>
