                    ...
                    <ul class="nav navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Mobiles</a>
                                   <a href="products.php#shirt" class="dropdown-item">Laptops</a>
                                   <a href="products.php#shoes" class="dropdown-item">Electronic Aplliances</a>
                                   <a href="products.php#headphones" class="dropdown-item">Fashion</a>
                               </div>
                       </li>
